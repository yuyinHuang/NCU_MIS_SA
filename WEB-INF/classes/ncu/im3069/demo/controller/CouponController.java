...
public class CouponController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String sn = jso.getString("sn");
        int price = jso.getInt("price");
        int id_OrderGet= jso.getInt("id_OrderGet"); 
        int id_Member= jso.getInt("id_Member"); 
        
       
        
        /** 建立一個新的會員物件 */
        Coupon c = new Coupon(sn, price, id_OrderGet, id_Member);
    ...
    public void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        int id_OrderGet= jso.getInt("id_OrderGet"); 
        int id_Member= jso.getInt("id_Member"); 
        int id_OrderUsed = jso.getInt("id_OrderUesd");

        /** 透過傳入之參數，新建一個以這些參數之會員Member物件 */
        Coupon c = new Coupon(sn, price, id_OrderGet, id_Member, id_OrderUsed);
